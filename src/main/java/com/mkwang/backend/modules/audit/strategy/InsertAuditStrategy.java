...
public class InsertAuditStrategy implements AuditExtractionStrategy {
    ...
    public AuditMessageDTO extract(String entityName, String entityId, Long actorId,
        ...
        for (int i = 0; i < propertyNames.length; i++) {
            ...
            Object value = newState != null ? newState[i] : null;
            newMap.put(propName, maskIfSensitive(propName, value));
        }
    ...
    private String toJson(Map<String, Object> map) {
        try {
            ...
            log.warn("[InsertAuditStrategy] JSON serialize failed: {}", e.getMessage());
            return null;
        }
    }
}
